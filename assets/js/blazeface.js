...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		? e(exports, require("@tensorflow/tfjs-core"), require("@tensorflow/tfjs-converter"))
		: "function" == typeof define && define.amd
		? define(["exports", "@tensorflow/tfjs-core", "@tensorflow/tfjs-converter"], e)
					...
					(this.anchorsData = (function (t, e, n) {
						for (var r = [], o = 0; o < n.strides.length; o++)
							for (var i = n.strides[o], s = Math.floor((e + i - 1) / i), a = Math.floor((t + i - 1) / i), c = n.anchors[o], u = 0; u < s; u++)
								for (var l = i * (u + 0.5), d = 0; d < a; d++) for (var f = i * (d + 0.5), h = 0; h < c; h++) r.push([f, l]);
						return r;
					})(n, r, a)),
								...
								switch (T.label) {
									...
									case 3:
										for (
												...
												w = function (t) {
													var r = p[t],
														o = e.tidy(function () {
															...
															var a,
																u = h[t];
															return (a = n ? e.slice(x.anchors, [u, 0], [1, 2]) : x.anchorsData[u]), { box: o, landmarks: e.reshape(e.squeeze(e.slice(c, [u, 5], [1, -1])), [6, -1]), probability: e.slice(l, [u], [1]), anchor: a };
														});
													y.push(o);
												},
												g = 0;
											...
											w(g);
										return u.dispose(), l.dispose(), c.dispose(), [2, { boxes: y, scaleFactor: m }];
								}
							});
						})
					);
										...
										return (
											...
											n
												? [
														...
														h.map(function (t) {
															var n = u(t, p),
																r = { topLeft: e.slice(n, [0], [2]), bottomRight: e.slice(n, [2], [2]) };
															if (s) {
																var o = t,
																	a = o.landmarks,
																	d = o.probability,
																...
																return r(b, void 0, void 0, function () {
																	...
																	return o(this, function (x) {
																		switch (x.label) {
																			...
																			case 1:
																				return (f = x.sent()), (n = { topLeft: f.slice(0, 2), bottomRight: f.slice(2) }), [3, 4];
																			case 2:
																				return [
																					4,
																					Promise.all(
																			...
																			case 3:
																				(a = x.sent()),
																					...
																					(n = { topLeft: f.slice(0, 2), bottomRight: f.slice(2), landmarks: w, probability: h }),
