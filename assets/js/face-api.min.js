!(function (t, e) {
		...
		Ht =
			...
			(qt.prototype.memory = function () {
				...
				return (
					...
					0 < this.state.numStringTensors && ((t.unreliable = !0), null == t.reasons && (t.reasons = []), t.reasons.push("Memory usage by string tensors is approximate (2 bytes per character)")),
					t
				);
			}),
		...
		return (
			(l =
				2 === _().getNumber("WEBGL_VERSION")
					? ((n = h.R32F), (r = h.R16F), (o = h.RGBA16F), (i = h.RGBA32F), (a = h.RED), (s = 4), (u = 1), (c = h.HALF_FLOAT), h.FLOAT)
					: ((n = t.RGBA), (r = t.RGBA), (o = t.RGBA), (i = h.RGBA), (a = t.RGBA), (u = s = 4), (c = null != e ? e.HALF_FLOAT_OES : null), t.FLOAT)),
			{
					...
					(i.next = function () {
						...
						(function (t, e) {
							...
							for (e === (0 | e) ? ((r = e), (e = null)) : ((e += "\0"), (r = 0), (u = Math.max(u, e.length))), o = 0, i = -32; i < u; ++i)
								e && (r ^= e.charCodeAt((i + 32) % e.length)), 0 === i && (a = r), (r ^= r << 10), (r ^= r >>> 15), (r ^= r << 4), (r ^= r >>> 13), 0 <= i && ((a = (a + 1640531527) | 0), (o = 0 == (n = s[127 & i] ^= r + a) ? o + 1 : 0));
				...
				function i(t) {
					...
					(o.next = function () {
						var t = o.b,
							...
							r = o.a;
						return (
							(t = (t << 25) ^ (t >>> 7) ^ e), (e = (e - n) | 0), (n = (n << 24) ^ (n >>> 8) ^ r), (r = (r - t) | 0), (o.b = t = (t << 20) ^ (t >>> 12) ^ e), (o.c = e = (e - n) | 0), (o.d = (n << 16) ^ (e >>> 16) ^ r), (o.a = (r - t) | 0)
						);
					}),
						(o.a = 0),
						(o.b = 0),
						...
						return {
							x: function () {
								...
								if (1 === a.rank) for (var e = 0; e < s[0]; ++e) t = t.add(i.slice([e * a.shape[0]], [a.shape[0]]));
									...
									for (e = 0; e < s[0]; ++e)
										for (n = 0; n < s[1]; ++n) for (r = 0; r < s[2]; ++r) for (var o = 0; o < s[3]; ++o) t = t.add(i.slice([e * a.shape[0], n * a.shape[1], r * a.shape[2], o * a.shape[3]], [a.shape[0], a.shape[1], a.shape[2], a.shape[3]]));
								}
								return t;
							},
						};
	...
	function bo(t, e, n, r, o, m, i, a) {
		...
		var f,
			...
			D = i ? v * h : v;
		return (
			"channelsFirst" === a ? (f = [u, D, k, S]) : "channelsLast" === a && (f = [u, k, S, D]),
			{
				batchSize: u,
				dataFormat: a,
				inHeight: c,
	...
	function wo(t, e, n, r, o, i, a, E) {
		...
		var p,
			...
			O = i ? g * f : g;
		return (
			"channelsFirst" === a ? (p = [u, O, N, F, M]) : "channelsLast" === a && (p = [u, N, F, M, O]),
			{
				batchSize: u,
				dataFormat: a,
				inDepth: c,
											...
											if (1 !== a || d || v) {
												if (d && !v) p = 1 === s ? "\n        return vec4(outputValue.x, outputValue.x, 0., 0.);\n      " : "\n        return vec4(outputValue.x);\n      ";
													...
													-1 < u.indexOf(m) && -1 < u.indexOf(g)
														...
														: -1 < u.indexOf(m)
														? (p = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);")
														: -1 < u.indexOf(g) && (p = "return vec4(outputValue.xx, outputValue.zz);");
												}
	...
	function li(t, e, n, r, o, i) {
		...
		var s = "1.0";
		null != o && (go(t, o), this.variableNames.push("scale"), (s = "getScaleAtOutCoords()")),
			(this.outputShape = t),
			(this.userCode =
			...
			(ba.prototype.getQueryTimerExtension = function () {
				return (
					null == this.disjointQueryTimerExtension &&
						(this.disjointQueryTimerExtension = pe(this.gl, this.debug, 2 === _().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query")),
			...
			((es.prototype.acquireTexture = function (t, e, n) {
				...
				return (
					...
					o === Qt.PACKED_2X2_FLOAT32
						...
						: o === Qt.PACKED_4X1_UNSIGNED_BYTE && (r = this.gpgpu.createUnsignedBytesMatrixTexture(t[0], t[1])),
					...
					return R(this, function (t) {
						switch (t.label) {
							case 0:
								...
								if (((n = this.texData.get(E)), (r = n.values), (o = n.shape), (i = n.slice), (a = n.dtype), (s = n.complexTensors), (u = n.isPacked), null != i))
									return (c = u ? new cs(o, Es) : new us(o, Es)), (l = this.runWebGLProgram(c, [{ dataId: E, shape: o, dtype: a }], a)), (h = this.read(l.dataId)), this.disposeData(l.dataId), [2, h];
								...
								return (
									(f = null),
									"complex64" !== a && _().get("WEBGL_BUFFER_SUPPORTED") && ((p = this.decode(E)), (d = this.texData.get(p.dataId)), (f = (C = this.gpgpu).createBufferFromTexture.apply(C, [d.texture].concat(se(o))))),
								...
								x: function () {
									return (function (t, e, n, r, o, i, a, s) {
										var u = cn(g, "dy", "maxPool3dBackprop"),
											...
											d = !1;
										4 === c.rank &&
											((d = !0), (h = u.as5D(1, u.shape[0], u.shape[1], u.shape[2], u.shape[3])), (f = c.as5D(1, c.shape[0], c.shape[1], c.shape[2], c.shape[3])), (p = l.as5D(1, l.shape[0], l.shape[1], l.shape[2], l.shape[3]))),
											P(5 === h.rank, function () {
	...
	var tl = wn({
		...
		El = wn({
			stridedSlice_: function (t, e, n, r, o, i, a, s, u) {
				if ((void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === a && (a = 0), void 0 === s && (s = 0), void 0 === u && (u = 0), null == r && (r = new Array(e.length)), 0 !== a))
		...
		_h =
						...
						for (var P = 0; P < v; ++P)
							for (var B = P - E, L = Math.max(0, Math.ceil(B / b)), W = Math.min(y, (f + B) / b), z = 0; z < m; ++z) {
								for (var U = z - _, V = Math.max(0, Math.ceil(U / w)), G = Math.min(x, (p + U) / w), H = 0, q = L; q < W; ++q)
									for (var j = q * b - B, K = V; K < G; ++K) for (var X = A * M + T * q + N * K, Y = u * (f - 1 - j) + c * (p - 1 - (K * w - U)) + l * O, $ = 0; $ < g; ++$) H += i[X + F * $] * a[Y + $];
								o[R * M + k * P + S * z + D * O] = H;
							}
				return r.toTensor();
			}),
						...
						for (var O = 0; O < E; ++O)
							for (var P = O - A, B = Math.max(0, Math.ceil(P / S)), L = Math.min(R, (b + P) / S), W = 0; W < _; ++W) {
								for (var z = W - T, U = Math.max(0, Math.ceil(z / D)), V = Math.min(k, (w + z) / D), G = 0, H = B; H < L; ++H)
									for (var q = H * S - P, j = U; j < V; ++j) for (var K = h * F + f * H + p * j, X = m * (b - 1 - q) + g * (w - 1 - (j * D - z)) + y * M, Y = 0; Y < N; ++Y) G += c[K + (M * N + Y)] * d[X + Y];
								o[a * F + s * O + u * W + M] = G;
							}
				return r.toTensor();
			}),
			...
			(Ih.prototype.batchNormalization = function (t, e, n, r, o, i) {
				...
				for (
					...
					(h[b] = l[m++] + ((a[b] - s[g++]) * c[y++]) / Math.sqrt(u[x++] + r)), f <= m && (m = 0), v <= g && (g = 0), p <= y && (y = 0), d <= x && (x = 0);
				return Tn(h, t.shape);
			}),
		...
		(Cf.prototype.load = function () {
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					...
					if (
						((n.weightSpecs = o),
						null != (i = this.LS.getItem(this.keys.modelMetadata)) && ((a = JSON.parse(i)), (n.format = a.format), (n.generatedBy = a.generatedBy), (n.convertedBy = a.convertedBy), (n.userDefinedMetadata = a.userDefinedMetadata)),
														...
														t.paths.forEach(function (r) {
															...
															(t.onload = function (t) {
																var e = t.target.result,
																	n = s.indexOf(r);
																(u[n] = e),
																	-1 === u.indexOf(null) && c({ modelTopology: i, weightSpecs: a, weightData: qh(u), format: o.format, generatedBy: o.generatedBy, convertedBy: o.convertedBy, userDefinedMetadata: o.userDefinedMetadata });
															}),
																(t.onerror = function (t) {
					...
					switch (t.label) {
						case 0:
							...
							return (
								...
								(r = { modelTopology: i.modelTopology, format: i.format, generatedBy: i.generatedBy, convertedBy: i.convertedBy, userDefinedMetadata: i.userDefinedMetadata, weightsManifest: n }),
			...
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					switch (t.label) {
						...
						case 5:
							if (((o = n.modelTopology), (i = n.weightsManifest), (a = n.generatedBy), (s = n.convertedBy), (u = n.format), (c = n.userDefinedMetadata), null == o && null == i))
			...
			fromMemory: function (t, e, n, r) {
				return 1 === arguments.length
					...
					: (console.warn(
					  ...
					  new Lf({ modelTopology: t, weightSpecs: e, weightData: n, trainingConfig: r }));
			},
			...
			fromPixels_: function (t, e) {
				...
				if (
					(a
						...
						: r || n
						? (s = t.data)
						: (i || o) && (null == Vf && (Vf = document.createElement("canvas").getContext("2d")), (Vf.canvas.width = l), (Vf.canvas.height = h), Vf.drawImage(t, 0, 0, l, h), (s = Vf.getImageData(0, 0, l, h).data)),
					4 === e)
				)
					u = new Int32Array(s);
				else {
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 2:
								...
								for (d = "float32" === e.dtype ? 255 : 1, v = new Uint8ClampedArray(o * r * 4), m = 0; m < r * o; ++m)
									(b = x = y = g = void 0),
										1 === i
											? ((g = a[m] * d), (y = a[m] * d), (x = a[m] * d), (b = 255))
											: 3 === i
											? ((g = a[3 * m] * d), (y = a[3 * m + 1] * d), (x = a[3 * m + 2] * d), (b = 255))
											: 4 === i && ((g = a[4 * m] * d), (y = a[4 * m + 1] * d), (x = a[4 * m + 2] * d), (b = a[4 * m + 3] * d)),
		...
		yp =
			...
			(xp.prototype.applyGradients = function (p) {
				...
				nn(function () {
					...
					t.forEach(function (t, e) {
						var n = Kt.registeredVariables[t];
						null == d.accumulatedFirstMoment[e] && (d.accumulatedFirstMoment[e] = { originalName: t + "/m", variable: Un(n).variable(!1) }),
							null == d.accumulatedWeightedInfNorm[e] && (d.accumulatedWeightedInfNorm[e] = { originalName: t + "/v", variable: Un(n).variable(!1) });
						var r = Array.isArray(p) ? p[e].tensor : p[t];
						if (null != r) {
							var o = d.accumulatedFirstMoment[e].variable,
	...
	function xv(t, e) {
		var o = this;
		if ((void 0 === e && (e = !1), (this._imageTensors = []), (this._canvases = []), (this._treatAsBatchInput = !1), (this._inputDimensions = []), !Array.isArray(t)))
	...
	((gm = c.Gender || (c.Gender = {})).FEMALE = "Wanita"), (gm.MALE = "Pria");
	var bm,
		wm =
			(Pp(Cm, (bm = kv)),
							...
							(t = Gm(
								(t = Gm(
									(t = Hm(
										(t = Gm(
											(t = Gm(
												(t = Hm((t = Gm((t = Gm((t = Gm((t = Hm((t = Gm((t = Gm((t = Gm((t = Gc(t, 3, 2, "valid")), r.conv32_1)), r.conv32_2)), r.conv32_3)), r.conv64_down)), r.conv64_1)), r.conv64_2)), r.conv64_3)), r.conv128_down)),
												r.conv128_1,
											)),
											r.conv128_2,
										)),
			...
			return {
				depthwise_conv: (function (t, e) {
					var n = Tn(s(9 * t), [3, 3, t, 1]),
						...
						a = Sn(s(t));
					return (
						u.push({ paramPath: e + "/filters" }, { paramPath: e + "/batch_norm_scale" }, { paramPath: e + "/batch_norm_offset" }, { paramPath: e + "/batch_norm_mean" }, { paramPath: e + "/batch_norm_variance" }),
						{ filters: n, batch_norm_scale: r, batch_norm_offset: o, batch_norm_mean: i, batch_norm_variance: a }
					);
				})(t, n + "/depthwise_conv"),
		...
		Ag =
			...
			(Tg.prototype.runTinyYolov2 = function (t, e) {
				...
				return (
					...
					Nv((n = Eg((n = Eg((n = Gc(n, [2, 2], [1, 1], "same")), e.conv6)), e.conv7)), e.conv8, "valid", !1)
				);
			}),
									...
									? ((y = bd(p[v][m][g][0])),
									  !F || F < y
											? ((x = ((m + bd(d[v][m][g][0])) / a) * o),
											  ...
											  (w = ((Math.exp(d[v][m][g][2]) * this.config.anchors[g].x) / a) * o),
											  (C = ((Math.exp(d[v][m][g][3]) * this.config.anchors[g].y) / a) * i),
											  (E = x - w / 2),
											  (_ = b - C / 2),
											  (I = { row: v, col: m, anchor: g }),
											  this.withClassScores ? [4, this.extractPredictedClass(h, I)] : [3, 7])
											: [3, 9])
									: [3, 10];
							case 6:
								return (D = t.sent()), [3, 8];
		...
		return (
			...
			nn(function () {
				...
				return (
					...
					(t = Jg((t = Nv((t = Gc(t, r ? [2, 2] : [3, 3], [2, 2], "same")), n.conv2, "valid")), n.prelu2_alpha)),
					(t = Jg((t = Nv((t = r ? t : Gc(t, [3, 3], [2, 2], "valid")), n.conv3, "valid")), n.prelu3_alpha))
				);
			})
		);
	}
