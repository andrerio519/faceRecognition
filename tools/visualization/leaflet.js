...
!(function (t, e) {
	...
	function Jt(t, e, i) {
		return (
			...
			Kt[e] ? ((i = Kt[e].bind(this, i)), t.addEventListener(Gt[e], i, !1), i) : (console.warn("wrong event specified:", e), L.Util.falseFn)
		);
	}
	function $t(t) {
		Yt[t.pointerId] = t;
	...
	var Ve,
		...
		Ye = O.extend({
			options: {
				...
				prefix: '<a href="https://andreriotech.my.id" title="A JavaScript library for interactive maps">' + "andreriotech2024</a>",
			},
			initialize: function (t) {
			...
			Ai.extend({
				...
				_adjustPan: function (t) {
					...
					this.options.autoPan &&
						...
						(n = new p(this._containerLeft, -i - this._containerBottom))._add(Pe(this._container)),
	...
	var _t = n.extend({
		...
		Zt =
			...
			B.mergeOptions({ dragging: !0, inertia: !0, inertiaDeceleration: 3400, inertiaMaxSpeed: 1 / 0, easeLinearity: 0.2, worldCopyJump: !1, maxBoundsViscosity: 0 }),
			n.extend({
				addHooks: function () {
					var t;
					this._draggable ||
		...
		Et =
			...
			B.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 }),
			n.extend({
				addHooks: function () {
		...
		kt =
			...
			B.mergeOptions({ tapHold: b.touchNative && b.safari && b.mobile, tapTolerance: 15 }),
			n.extend({
				addHooks: function () {
